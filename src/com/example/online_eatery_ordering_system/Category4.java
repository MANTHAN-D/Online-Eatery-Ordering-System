...
public class Category4 extends Activity {
	...
	public void onBackPressed(){
		//Intent in=new Intent(Category4.this, ViewMenu.class);
		if(orderedItems!=null)
	...
	private void action(){
	    ...
	    db.open();
	    Cursor c=db.getAllItems("sandwiches");
	    i=0;
	    if(c.moveToFirst()){
	    	do{
	    ...
	    button_ordernow.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				checkAndAddItems();
				//Intent in=new Intent(Category4.this, PlaceOrder.class);
	...
	public void checkAndAddItems(){
		...
		for(int i=0;i<item.length;i++){
			if(item[i].isChecked()){
				...
				orderedItems.putSerializable("c4_item"+counter,obj);
			}
		}
