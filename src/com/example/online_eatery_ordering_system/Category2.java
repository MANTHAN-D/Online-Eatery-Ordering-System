...
public class Category2 extends Activity {
	...
	public void onBackPressed(){
		//Intent in=new Intent(Category2.this, ViewMenu.class);
		if(orderedItems!=null)
	...
	private void action(){
	    ...
	    db.open();
	    Cursor c=db.getAllItems("burgers");
	    i=0;
	    if(c.moveToFirst()){
	    	do{
	...
	public void checkAndAddItems(){
		...
		for(int i=0;i<item.length;i++){
			if(item[i].isChecked()){
				counter++;
				while(true){
					SelectedItemObject obj1=(SelectedItemObject) orderedItems.get("c2_item"+counter);
					if(obj1==null)
						break;
					counter++;
				}
				...
				orderedItems.putSerializable("c2_item"+counter,obj);
			}
		}
