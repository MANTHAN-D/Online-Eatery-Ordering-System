...
public class Category3 extends Activity {
	...
	public void onBackPressed(){
		//Intent in=new Intent(Category3.this, ViewMenu.class);
		if(orderedItems!=null)
	...
	private void action(){
	    ...
	    db.open();
	    Cursor c=db.getAllItems("pizzas");
	    i=0;
	    if(c.moveToFirst()){
	    	do{
	    ...
	    button_ordernow.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				//Bundle orderedItems=checkAndAddItems();
				checkAndAddItems();
				//Intent in=new Intent(Category3.this, PlaceOrder.class);
	...
	public void checkAndAddItems(){
		...
		for(int i=0;i<item.length;i++){
			if(item[i].isChecked()){
				counter++;
				while(true){
					SelectedItemObject obj1=(SelectedItemObject) orderedItems.get("c3_item"+counter);
					if(obj1==null)
						break;
					counter++;
				}
				...
				orderedItems.putSerializable("c3_item"+counter,obj);
			}
		}
